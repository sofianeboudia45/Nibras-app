...
def create_pdf(name, age, glucose, result):
    ...
    # هنا سيتم وضع اسم المريض الذي تدخله
...
with st.sidebar:
    ...
    # ملاحظة: يفضل كتابة الاسم بالإنجليزية لتجنب أي أخطاء في الـ PDF
...
if predict_btn and name:
    ...
    st.download_button("Download Report", data=pdf_data, file_name=f"{name}_report.pdf", mime="application/pdf")
